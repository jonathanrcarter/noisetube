  ...
  module Acts
    module TaggableOn
      ...
      module SingletonMethods
        ...
        def tag_counts_on(context=nil, options = {})
          options=options.merge({:on => context.to_s}) unless context.nil?
        ...
        def find_options_for_tag_counts(options = {})
          ...
          joins << options[:joins] unless options[:joins].nil?
          
          #joins << "LEFT OUTER JOIN tracks ON #{table_name}.#{primary_key} = #{Tagging.table_name}.taggable_id"
