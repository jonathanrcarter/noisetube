...
public abstract class MeasuringForm extends Form implements IMeasurementUI, ActionListener
{
	...
	public Command cmdPauseResume = new Command(JavaMENTClient.BRUSSENSE ? "Pauze" : "Pause");
	public Command cmdExit = new Command(JavaMENTClient.BRUSSENSE ? "Afsluiten" : "Exit");
