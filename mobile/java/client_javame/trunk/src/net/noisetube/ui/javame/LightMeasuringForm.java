...
public class LightMeasuringForm extends MeasuringForm
{
	...
	protected void initialize()
	{
		...
		lblAvrDBA = new Label((JavaMENTClient.BRUSSENSE ? "Gem" : "Avr") + ": 0.0");
	...
	public void newMeasurement(Track track, Measurement measurement, Measurement savedMeasurement)
	{
		...
		setTitle("#" + track.getStatistics().getNumMeasurements() + " (" + StringUtils.formatTimeSpanColons(track.getTotalElapsedTime()) + ")");
		MeasurementStatistics stats = track.getStatistics();
		lblAvrDBA.setText((JavaMENTClient.BRUSSENSE ? "Gem" : "Avr") + ": " + MathME.roundTo(stats.getAvrdBA(), 2));
