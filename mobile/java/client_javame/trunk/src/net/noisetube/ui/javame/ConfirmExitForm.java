...
public class ConfirmExitForm extends Form
{
	...
	public ConfirmExitForm()
	{
		...
		txtInfo.setText(JavaMENTClient.BRUSSENSE ? "Ben je zeker dat je deze meetsessie wil afsluiten?" : "Are you sure you want to exit NoiseTube?");

		addComponent(BorderLayout.NORTH, txtInfo);

		final Command cmdOk = new Command(JavaMENTClient.BRUSSENSE ? "Ja" :"Yes");
		addCommand(cmdOk);

		final Command cmdCancel = new Command(JavaMENTClient.BRUSSENSE ? "Nee" :"No");
