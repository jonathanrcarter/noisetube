...
public class AboutForm extends Form
{
	...
	public AboutForm()
	{
		...
		try
		{
			Image logo = Image.createImage("/" +
				(JavaMEDevice.hasSmallScreen() ? "icons/NoiseTubeIcon64x64.png" : "/NoiseTubeLogo.png"));
		...
		txtClient.setText(JavaMENTClient.CLIENT_TYPE + " " + JavaMENTClient.CLIENT_VERSION);
