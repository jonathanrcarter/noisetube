...
public class TaggingUIComponent extends Container
{
	...
	public TaggingUIComponent()
	{
		...
		txtTags.addFocusListener(new FocusListener()
		{
		...
		txtTags.addDataChangeListener(new DataChangedListener()
		{
	...
	private void fire(String tagstring)
	{
		...
		{
			taggingComp.setTags(tagstring, tagTimeStamp);
			tagTimeStamp = 0;
			addTag(tagstring);
