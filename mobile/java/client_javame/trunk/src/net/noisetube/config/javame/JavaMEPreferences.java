...
public class JavaMEPreferences extends Preferences
{
	...
	static private final String STORE_NAME = "noisetube" + JavaMENTClient.CLIENT_VERSION + (JavaMENTClient.RESEARCH_BUILD ? "R" : "");
	...
	public void saveToStorage()
	{
		...
		{
			log.error(ex, "Exception upon saving preferences");
		}
		finally
		{
			try
	...
	public void loadFromStorage()
	{
		...
		{
			log.debug("No previous preferences stored");
			return;
		}
		catch(Exception ex)
		{
			log.error(ex, "Exception upon loading preferences");
		}
		finally
		{
			try
	...
	protected void writeSettingsTo(DataOutput dos) throws IOException
	{
		...
		dos.writeBoolean(isAlwaysUseBatchModeForHTTP());
		...
		//Java ME specific
		dos.writeBoolean(isPauseWhenInBackground());
	...
	protected void readSettingsFrom(DataInputStream dis) throws IOException
	{
		...
		setAlwaysUseBatchModeForHTTP(dis.readBoolean());
		...
		//Java ME specific
		setPauseWhenInBackground(dis.readBoolean());
