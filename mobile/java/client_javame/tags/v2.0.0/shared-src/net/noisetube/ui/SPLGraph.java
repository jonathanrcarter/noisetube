...
public class SPLGraph
{
	...
	public void draw(Object graphics_canvas)
	{
		...
		while(e.hasMoreElements())
		{
			...
			double currentOffset = (current.isLoudnessLeqDBASet() ? current.getLoudnessLeqDBA() : current.getLoudnessLeqDB()) - minimumDB;
			double nextOffset = (next.isLoudnessLeqDBASet() ? next.getLoudnessLeqDBA() : next.getLoudnessLeqDB()) - minimumDB;
			...
			if(current.hasTags())
			{	//TODO differentiate between user (blue) & automatic tags (red)
