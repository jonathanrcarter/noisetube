...
public abstract class LocationComponent
{
	...
	protected final int DISABLE_GPS_AFTER_MINUTES = 7;
	protected final int RETRY_GPS_AFTER_MINUTES = 10;
	...
	public synchronized NTLocation getLastLocation()
	{
		...
		if(locationToReturn != null && preferences.isUseGPS())
		{
			...
			if(isGPSEnabled())
			{
				...
				if(!preferences.isForceGPS() && System.currentTimeMillis() - lastLocation.getCoordinates().getTimeStamp() > DISABLE_GPS_AFTER_MINUTES * 60 * 1000)
