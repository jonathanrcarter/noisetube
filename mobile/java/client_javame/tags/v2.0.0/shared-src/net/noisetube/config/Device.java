...
public abstract class Device
{
	...
	//STATIC-----------------------------------------------
	protected static final int AUDIO_RECORDING_TEST_DURATION_MS = 250; //ms
	...
	protected boolean testAudioSpecification(AudioSpecification as)
	{
		try
		{
			AudioRecorder recorder = client.getAudioRecorder(as, (int) (AUDIO_RECORDING_TEST_DURATION_MS * (1f + AudioComponent.DEFAULT_RECORDING_TIME_OVERSHOOT_RATIO)), null);
			AudioStream stream = recorder.record();
			return stream.isValid(AUDIO_RECORDING_TEST_DURATION_MS) && stream.isDecodeable();
		}
		catch(Exception e)
		{
