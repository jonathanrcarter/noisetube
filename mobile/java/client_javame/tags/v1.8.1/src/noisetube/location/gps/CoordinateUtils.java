...
public class CoordinateUtils
{
	...
	{
		return(coordsX.getLatitude() == coordsY.getLatitude() && coordsX.getLongitude() == coordsY.getLongitude() && coordsX.getAltitude() == coordsY.getAltitude());
	}
	 ...
	 * 
	 */
	public static Coordinates translate(Coordinates startingPoint, double courseInDegrees, double distanceInMeter) throws Exception
	{
		...
		return new Coordinates(Math.toDegrees(glat2), Math.toDegrees(glon2), startingPoint.getAltitude());
	}
