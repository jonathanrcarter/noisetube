...
public class CalibrationFactory
{
	...
	{
		this.client = NTClient.getInstance();
		...
		if(device.supportsInternetAccess())
		{
			...
			calibrationsList = (new NTWebAPI()).downloadCalibrations(parser);
		}
	...
	public static class CalibrationsList
	{
		...
		public void saveToFile()
		{
			...
			{
				Logger.getInstance().error(e, "Could not write calibrations to file");
			}		
		}
