...
public class XMLUtils
{
	 ...
	 *  - YYYY-MM-DDThh:mm:sszzzzzz format for non-UTC times, where zzzzzz represents ±hh:mm in relation to UTC</br>
	 * 
	 * Info:</br>
	 *   - <a href="http://code.google.com/apis/kml/documentation/kmlreference.html#timestamp">http://code.google.com/apis/kml/documentation/kmlreference.html#timestamp</a></br>
	 *   - <a href="http://code.google.com/apis/kml/documentation/time.html">http://code.google.com/apis/kml/documentation/time.html</a>
	 * 
	 * @param timeStamp
	...
	static public String timeDateValue(long timeStamp)
	{
		...
		{	//time is not in UTC/GMT (add zzzzzz, which represents ±hh:mm in relation to UTC)
